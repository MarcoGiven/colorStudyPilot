...
psychoJS.start({
  ...
  resources: [
    ...
    {'name': "resources/images/4_matches/med4_1.png", 'path': "resources/images/4_matches/med4_1.png"},
    {'name': "resources/images/4_matches/med4_2.png", 'path': "resources/images/4_matches/med4_2.png"},
    {'name': "resources/images/4_matches/med4_3.png", 'path': "resources/images/4_matches/med4_3.png"},
    {'name': "resources/images/4_matches/med4_4.png", 'path': "resources/images/4_matches/med4_4.png"},
    {'name': "resources/images/4_matches/med4_5.png", 'path': "resources/images/4_matches/med4_5.png"},
    ...
    {'name': "resources/images/4_matches/imp4_1.png", 'path': "resources/images/4_matches/imp4_1.png"},
    {'name': "resources/images/4_matches/imp4_2.png", 'path': "resources/images/4_matches/imp4_2.png"},
    {'name': "resources/images/4_matches/imp4_3.png", 'path': "resources/images/4_matches/imp4_3.png"},
    {'name': "resources/images/4_matches/imp4_4.png", 'path': "resources/images/4_matches/imp4_4.png"},
    {'name': "resources/images/4_matches/imp4_5.png", 'path': "resources/images/4_matches/imp4_5.png"},
...
function EndScreenRoutineBegin(snapshot) {
  return async function () {
    ...
    const accKeys = ['key_resp.corr', 'key_resp2.corr', 'key_easy.corr', 'key_hard.corr'];
    const rtKeys  = ['key_resp.rt',   'key_resp2.rt',   'key_easy.rt',   'key_hard.rt'];
